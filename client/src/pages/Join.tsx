  ...
  return (
    <div className="app-shell auth-screen">
      <div className="auth-layout">
        ...
        <main className="auth-panel"><div className="mb-10"><span className="inline-flex rounded-full bg-lilac/15 text-lilac px-3 py-1.5 text-xs font-bold items-center gap-2"><Sparkles size={13} /> 18+ · Bengaluru & beyond</span></div>
