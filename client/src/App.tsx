    ...
    <AppFrame>
      <Switch>
        ...
        <Route path="/onboarding/profile">
          <OnboardingGate step="profile"><ProfileSetup /></OnboardingGate>
        </Route>
        <Route path="/onboarding/quiz">
          <OnboardingGate step="quiz"><Quiz /></OnboardingGate>
        </Route>
        <Route path="/onboarding/vibe-card">
          <OnboardingGate step="quiz"><VibeCard /></OnboardingGate>
        </Route>
        <Route path="/onboarding/avatar">
          <OnboardingGate step="avatar"><AvatarPicker /></OnboardingGate>
        </Route>
        <Route path="/plans">
          <RequireDone><Plans /></RequireDone>
        </Route>
        <Route path="/chats">
          <RequireDone><Chats /></RequireDone>
        </Route>
        ...
        <Route path="/me/emergency-contacts">
          <RequireDone><EmergencyContacts /></RequireDone>
        </Route>
        <Route path="/me">
          <RequireDone><Me /></RequireDone>
        </Route>
        <Route path="/chat/:groupId">
          <RequireDone><ChatRoom /></RequireDone>
        </Route>
        <Route path="/legal/:page" component={Legal} />
        <Route>
          <div className="app-shell flex items-center justify-center min-h-screen"><p className="text-muted text-sm">Page not found.</p></div>
        </Route>
      </Switch>
    </AppFrame>
  )
